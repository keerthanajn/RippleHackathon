  ...
  return (
    <div className="login-container">
          ...
          >
            <div className="login-nav">
              ...
              <nav className="login-links1">
                ...
                <span className="login-nav22 bodySmall">Login</span>
                <span className="login-nav32 bodySmall">Transfer</span>
                <span className="login-nav42 bodySmall">Transactions</span>
                <span className="login-nav52 bodySmall">Profile</span>
              </nav>
      ...
      <div className="login-footer">
        <footer className="footerContainer login-footer1">
          <div className="login-container1">
            <span className="logo">BANKIFY</span>
            <nav className="login-nav1">
              <span className="bodySmall">Home</span>
              <span className="login-nav221 bodySmall">Login</span>
              <span className="login-nav321 bodySmall">Transfer</span>
              <span className="login-nav421 bodySmall">Transactions</span>
              <span className="login-nav521 bodySmall">Profile</span>
            </nav>
          </div>
          <div className="login-separator"></div>
          <div className="login-container2">
            <span className="bodySmall login-text2">
