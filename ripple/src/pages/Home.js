...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>Extra Small Weekly Crocodile</title>
        <meta property="og:title" content="Extra Small Weekly Crocodile" />
      </Helmet>
          ...
          >
            <div className="home-nav">
              ...
              <nav className="home-links1">
                ...
                <span className="home-nav22 bodySmall">Login</span>
                <span className="home-nav32 bodySmall">Transfer</span>
                <span className="home-nav42 bodySmall">Transactions</span>
                <span className="home-nav52 bodySmall">Profile</span>
              </nav>
        ...
        <div className="heroContainer home-hero1">
          <div className="home-container01">
            <h1 className="home-hero-heading heading1">
              Secure Bank Transfer Website
            </h1>
            <span className="home-hero-sub-heading bodyLarge">
              <span>
                <span>
                  <span>
                    Your trusted platform for safe and efficient bank transfers
                  </span>
                  <span>
                    <span
          ...
          <div className="home-features1">
            <div className="home-container02">
              ...
              <h2 className="home-features-heading heading2">
                Key Features of Our Bank Transfer Website
              </h2>
              <span className="home-features-sub-heading bodyLarge">
                <span>
                  <span>
                    <span>
                      Experience seamless and secure online banking with our
                      advanced features
                    </span>
                    <span>
                      <span
        ...
        <div className="pricingContainer">
          <div className="home-container04">
            ...
            <span className="home-pricing-sub-heading bodyLarge">
              <span>
                <span>
                  Select a plan that suits your needs and enjoy seamless bank
                  transfers with ease.
                </span>
              </span>
            </span>
          ...
          <div className="home-container05">
            <div className="freePricingCard home-pricing-card">
              <div className="home-container06">
                ...
                <span className="bodySmall">Ideal for personal use</span>
              </div>
              ...
              <div className="home-container08">
                <div className="home-container09">
                  ...
                  <span className="bodySmall">Secure login</span>
                </div>
                <div className="home-container10">
                  <span className="home-text41">✔</span>
                  <span className="bodySmall">
                    Basic bank transfer functionality
                  </span>
                </div>
                ...
                <div className="home-container12">
                  ...
                  <span className="bodySmall">Email notifications</span>
                </div>
              </div>
            ...
            <div className="proPricingCard home-pricing-card2">
              <div className="home-container21">
                ...
                <span className="bodySmall">Perfect for large enterprises</span>
              </div>
              ...
              <div className="home-container23">
                ...
                <div className="home-container26">
                  ...
                  <span className="bodySmall">Advanced reporting tools</span>
                </div>
      ...
      <div className="home-banner">
        <div className="bannerContainer home-banner1">
          <h1 className="home-banner-heading heading2">
            Effortless Bank Transfers Made Simple
          </h1>
          <span className="home-banner-sub-heading bodySmall">
            <span>
              <span>
                <span>
                  Our website provides a seamless and secure way to transfer
                  funds between accounts. With advanced encryption and
                  user-friendly interface, you can easily manage your
                  transactions with peace of mind. Track your transfers, set up
                  recurring payments, and enjoy the convenience of online
                  banking.
                </span>
                <span>
                  <span
        ...
        <footer className="footerContainer home-footer1">
          <div className="home-container31">
            ...
            <nav className="home-nav1">
              ...
              <span className="home-nav221 bodySmall">Login</span>
              <span className="home-nav321 bodySmall">Transfer</span>
              <span className="home-nav421 bodySmall">Transactions</span>
              <span className="home-nav521 bodySmall">Profile</span>
            </nav>
          </div>
